...
muonPUPFIsoChHad03 = WWAnalysis.Tools.muonPFIsoSingleType_cfi.muonPFIsoSingleTypeMapProd.clone()
...
### DR=0.4 cone
# Charged Hadron isolation
muonPUPFIsoChHad04 = WWAnalysis.Tools.muonPFIsoSingleType_cfi.muonPFIsoSingleTypeMapProd.clone()
