...
electronPUPFIsoChHad03 = WWAnalysis.Tools.electronPFIsoSingleType_cfi.electronPFIsoSingleTypeMapProd.clone()
...
### DR=0.4 cone
# Charged Hadron isolation
electronPUPFIsoChHad04 = WWAnalysis.Tools.electronPFIsoSingleType_cfi.electronPFIsoSingleTypeMapProd.clone()
