...
public:
  ...
  static constexpr unsigned int kMaxSampleIdx = 8;          // Index of the sample at the maximum of the pulse
  ...
  static constexpr unsigned int kPulseShapeTemplateSampleSize = 11;  // Pulse shape template sample size for
                                                                             // multifit Eigen matrix types
  static constexpr int kMaxBX = 2; // Max possible active BX for multifit
  static constexpr int kMinBX = -3; // Max possible active BX for multifit
  static constexpr int kNActiveLHCPeriods = kMaxBX - kMinBX + 1;     // Number of active LHC periods for multifit algorithm
...
public:
  ...
  static constexpr unsigned int kPulseShapeTemplateSampleSize = 12;        // Pulse shape template sample size for
                                                                           // multifit Eigen matrix types
  static constexpr int kMaxBX = 4; // Max possible active BX for multifit
  static constexpr int kMinBX = -5; // Max possible active BX for multifit
  static constexpr int kNActiveLHCPeriods = kMaxBX - kMinBX + 1;     // Number of active LHC periods for multifit algorithm
