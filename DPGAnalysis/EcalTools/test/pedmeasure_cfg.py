...
process.load('DPGAnalysis.EcalTools.pedestalTask_cfi')

# now configure the analysis module
import DPGAnalysis.EcalTools.pedestalTask_cfi
process.pedestalMeasurement = DPGAnalysis.EcalTools.pedestalTask_cfi.pedestalTask.clone()
