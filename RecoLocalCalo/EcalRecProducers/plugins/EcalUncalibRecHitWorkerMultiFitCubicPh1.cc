...
private:
  ...
  edm::ESHandle<EcalPh1CubicPulseShapes> pulseshapes;
  edm::ESGetToken<EcalPh1CubicPulseShapes, EcalPh1CubicPulseShapesRcd> pulseShapesToken_;
  ...
  EcalUncalibRecHitMultiFitCubicAlgoPh1 multiFitMethod_;
...
EcalUncalibRecHitWorkerMultiFitCubicPh1::EcalUncalibRecHitWorkerMultiFitCubicPh1(const edm::ParameterSet& ps, edm::ConsumesCollector& c)
  ...
  pulseShapesToken_ = c.esConsumes<EcalPh1CubicPulseShapes, EcalPh1CubicPulseShapesRcd>();
