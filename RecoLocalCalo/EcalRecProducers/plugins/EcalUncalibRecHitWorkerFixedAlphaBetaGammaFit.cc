 ...
 *
 *  \author E. Di Marco, Mar 2014
 *
 */
#include "RecoLocalCalo/EcalRecProducers/plugins/EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit.h"
...
EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit::EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit(const edm::ParameterSet& ps) :
        EcalUncalibRecHitWorkerBaseClass( ps )
{
        ...
        alphabetaFilename_= ps.getUntrackedParameter<std::string>("AlphaBetaGammaFilename","NOFILE");
        useAlphaBetaGammaArray_=setAlphaBeta(); // set crystalwise values of alpha and beta
        if ( !useAlphaBetaGammaArray_ ) {
...
void
EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit::set(const edm::EventSetup& es)
{
        // Gain Ratios
...
bool
EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit::setAlphaBeta(){
...
bool
EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit::run(const edm::Event& evt, 
                ...
                EcalUncalibratedRecHitCollection & result)
{
        ...
        if( pedIter != pedMap.end() ) {
                ...
                edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << "error!! could not find pedestals for channel: ";
                if ( detid.subdetId() == EcalBarrel ) {
                        edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << EBDetId( detid );
                } else {
                        edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << EEDetId( detid );
                }
                edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << "\n  no uncalib rechit will be made for this digi!";
                return false;
        }
        double pedVec[3];
        ...
        if( gainIter != gainMap.end() ) {
                ...
                edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << "error!! could not find gain ratios for channel: ";
                if ( detid.subdetId() == EcalBarrel ) {
                        edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << EBDetId( detid );
                } else {
                        edm::LogError("EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit") << EEDetId( detid );
...
DEFINE_EDM_PLUGIN( EcalUncalibRecHitWorkerFactory, EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit, "EcalUncalibRecHitWorkerFixedAlphaBetaGammaFit" );
