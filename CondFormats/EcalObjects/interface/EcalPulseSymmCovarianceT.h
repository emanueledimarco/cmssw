#ifndef EcalPulseSymmCovariancesT_h
#define EcalPulseSymmCovariancesT_h
...
struct EcalPulseSymmCovarianceT {
public:
...
using EcalPh1PulseSymmCovariance = EcalPulseSymmCovarianceT<ecalPh1>;
...
using EcalPh2PulseSymmCovariance = EcalPulseSymmCovarianceT<ecalPh2>;
