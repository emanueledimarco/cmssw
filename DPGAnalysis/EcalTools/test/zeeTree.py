...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/group/dpg_ecal/comm_ecal/localreco/data2012_zskim_multifits/miniaod_datainputs_gainswitch/run2012ABCD_999.root')
)
...
# selections
from DPGAnalysis.EcalTools.zee_selections_cff import *
