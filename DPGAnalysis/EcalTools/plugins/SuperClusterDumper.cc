...
SuperClusterDumper::SuperClusterDumper(const edm::ParameterSet& iConfig)
{
  ...
  ecalBarrelSuperClusters3_ = iConfig.getParameter<edm::InputTag>("EBSuperClusters3");
  ecalEndcapSuperClusters3_ = iConfig.getParameter<edm::InputTag>("EESuperClusters3");
