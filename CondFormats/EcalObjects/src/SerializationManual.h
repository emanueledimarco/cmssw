...
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh1CubicPulseShape>);
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh2CubicPulseShape>);
...
COND_SERIALIZATION_INSTANTIATE(EcalCondObjectContainer<EcalPh1PulseSymmCovariance>);
...
COND_SERIALIZATION_INSTANTIATE(EcalPh1CubicPulseShape);
COND_SERIALIZATION_INSTANTIATE(EcalPh2CubicPulseShape);
COND_SERIALIZATION_INSTANTIATE(EcalPh2PulseSymmCovariance);
COND_SERIALIZATION_INSTANTIATE(EcalPh1PulseSymmCovariance);
