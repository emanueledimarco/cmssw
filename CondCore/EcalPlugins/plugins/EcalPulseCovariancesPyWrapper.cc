...
namespace cond {
	...
	struct ExtractWhat<EcalPulseCovariances> {
		...
		ecalpulsecovariance::Quantity const & quantity() const { return m_quantity;}
		ecalpulsecovariance::How const & how() const { return m_how;}
		std::vector<int> const & which() const { return m_which;}


		void set_quantity( ecalpulsecovariance::Quantity i) { m_quantity=i;}
		void set_how(ecalpulsecovariance::How i) {m_how=i;}
			...
			int ixSectorsEE[202] = {
				...
				36, 31, 31, 21, 21, 11, 11,  9,  0, 46, 46, 41, 41, 36, 36,  0, 56, 56, 61, 61, 66, 66};
                        ...
                        // for(int s = 7; s<12; ++s) {
                          ...
                          endc_m_s[s]->SetMaximum(1.0);
                          endc_m_s[s]->SetMinimum(1.0e-7);
                          ...
                          barrel_s[s]->SetMaximum(1.0);
                          barrel_s[s]->SetMinimum(1.0e-7);
                          ...
                          endc_p_s[s]->SetMaximum(1.0);
                          endc_p_s[s]->SetMinimum(1.0e-7);
...
namespace condPython {
	...
	void defineWhat<EcalPulseCovariances>() {
		...
		enum_<cond::ecalpulsecovariance::Quantity>("Quantity")
			...
			.value("sample_1",cond::ecalpulsecovariance::sample_1)
			.value("sample_2",cond::ecalpulsecovariance::sample_2)
			.value("sample_3",cond::ecalpulsecovariance::sample_3)
			.value("sample_4",cond::ecalpulsecovariance::sample_4)
			.value("sample_5",cond::ecalpulsecovariance::sample_5)
			.value("sample_6",cond::ecalpulsecovariance::sample_6)
			.value("sample_7",cond::ecalpulsecovariance::sample_7)
			.value("sample_8",cond::ecalpulsecovariance::sample_8)
			.value("sample_9",cond::ecalpulsecovariance::sample_9)
			;
		enum_<cond::ecalpulsecovariance::How>("How")
			.value("singleChannel",cond::ecalpulsecovariance::singleChannel)
			.value("bySuperModule",cond::ecalpulsecovariance::bySuperModule) 
