...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/group/dpg_ecal/comm_ecal/localreco/data2012_zskim_multifits/run2012A_datainputs_gainswitch/DoubleElectron_2012A_ZElectron-22Jan2013-v1_0.root')
)
