...
modules::MuonCleanerBySegmentsT<T>::isBetterMuon(const T &mu1, const T &mu2) const {
    ...
    if (mu1.userInt("pfMuId") != mu2.userInt("pfMuId")) return mu1.userInt("pfMuId");
...
namespace modules {
    ...
    typedef modules::MuonCleanerBySegmentsT<pat::Muon>   PATMuonCleanerBySegmentsUser;
}

#include "FWCore/Framework/interface/MakerMacros.h"
using namespace modules;
//DEFINE_FWK_MODULE(MuonCleanerBySegments);
DEFINE_FWK_MODULE(PATMuonCleanerBySegmentsUser);
