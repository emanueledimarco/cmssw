...
// Wed Nov 20 19:20:22 2013 by ROOT version 5.32/00
...
public :
   ...
   Float_t         calibEnergyEle[4];   //[nEle]
   Float_t         calibEnergyErrorEle[4];   //[nEle]
   Int_t           nPho;
   Int_t           nPerPVPho;
   ...
   Int_t           nPhoPFBC;
   Float_t         etaPhoPFBC[6];   //[nPhoPFBC]
   Float_t         thetaPhoPFBC[6];   //[nPhoPFBC]
   Float_t         phiPhoPFBC[6];   //[nPhoPFBC]
   Float_t         etaCrystalPhoPFBC[6];   //[nPhoPFBC]
   Float_t         phiCrystalPhoPFBC[6];   //[nPhoPFBC]
   Int_t           iEtaPhoPFBC[6];   //[nPhoPFBC]
   Int_t           iPhiPhoPFBC[6];   //[nPhoPFBC]
   Float_t         thetaTiltPhoPFBC[6];   //[nPhoPFBC]
   Float_t         phiTiltPhoPFBC[6];   //[nPhoPFBC]
   Int_t           indexSCPhoPFBC[6];   //[nPhoPFBC]
   Int_t           nTrack;
   ...
   Int_t           chargeAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         energyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         uncorrenergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         thetaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         etaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         phiAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pxAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pzAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpxAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         uncorrpzAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         vertexXAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         vertexYAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         vertexZAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         chargedHadronEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         neutralHadronEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         photonEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         electronEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         muonEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         HFHadronEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         HFEMEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           chargedHadronMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           neutralHadronMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           photonMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           electronMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           muonMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           HFHadronMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           HFEMMultiplicityAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         areaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz1AK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz2AK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         betastarAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandsHandAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         jetIdMvaFullAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         dR2MeanIdMvaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         dRMeanIdMvaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         betastarIdMvaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         betastarclassicIdMvaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         chargedEmEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         neutralEmEnergyAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexMVABJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         jetBProbabilityBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         jetProbabilityBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingVeryHighEffBJetTagsAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         ptDAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         axis1AK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         axis2AK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pullAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         tanaAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         rmsCand_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         ptD_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         axis1_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         axis2_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pull_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         tana_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCutAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           nChg_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCut_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           nNeutral_ptCutAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         RchgAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         RneutralAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         RAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         Rchg_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChgAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxNeutralAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChg_QCAK5PFPUcorrJet[85];   //[nAK5PFPUcorrJet]
   Int_t           nAK5GenJet;
   Int_t           chargeAK5GenJet[14];   //[nAK5GenJet]
   Float_t         energyAK5GenJet[14];   //[nAK5GenJet]
   Float_t         thetaAK5GenJet[14];   //[nAK5GenJet]
   Float_t         etaAK5GenJet[14];   //[nAK5GenJet]
   Float_t         phiAK5GenJet[14];   //[nAK5GenJet]
   Float_t         pxAK5GenJet[14];   //[nAK5GenJet]
   Float_t         pyAK5GenJet[14];   //[nAK5GenJet]
   Float_t         pzAK5GenJet[14];   //[nAK5GenJet]
   Float_t         vertexXAK5GenJet[14];   //[nAK5GenJet]
   Float_t         vertexYAK5GenJet[14];   //[nAK5GenJet]
   Float_t         vertexZAK5GenJet[14];   //[nAK5GenJet]
   Double_t        genPtHat;
